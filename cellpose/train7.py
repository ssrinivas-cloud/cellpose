...
def train_seg(net, train_data=None, train_labels_c=None, train_labels_o=None,
              ...
              learn_volcano=True, alpha=1.0, beta=0.1, **kwargs):  # <--- Added Volcano Args
    ...
    for iepoch in range(n_epochs):
        ...
        for k in range(0, nimg, batch_size):
            ...
            with torch.autocast(device_type=device.type, dtype=net.dtype):
                ...
                if debug and k == 0:
                    ...
                    # ---> NEW: WATCH THE NETWORK LEARN ALPHA AND BETA <---
        ...
        if debug and test_data:
            ...
            # ---> FIX 2: Added flow_threshold=0.0 to stop Cellpose from deleting valid masks <---
